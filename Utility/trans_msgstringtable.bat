...
del RagexeClient\2017-06-14\Basic\data\msgstringtable.txt
...
copy RagexeClient\2017-06-14\Basic\data\msgstringtable_original.txt RagexeClient\2017-06-14\Basic\data\msgstringtable.txt
